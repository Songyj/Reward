package com.example.songyanjun.reward;
...
import com.example.songyanjun.reward.Date.DateCallBack;
import com.example.songyanjun.reward.Date.DatePickerFragment;
...
public class MainActivity extends AppCompatActivity implements DateCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check.setOnClickListener(new View.OnClickListener(){
                                     @Override
                                     public void onClick(View v){
                                         new DoubleCheckFragment().show(getSupportFragmentManager(),"doublecheck");}
                                 }
        );
        /*Window dialogWindow = ;
